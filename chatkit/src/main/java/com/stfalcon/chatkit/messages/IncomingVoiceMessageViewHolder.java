...
/**
 * View holder for incoming voice messages
 */
public class IncomingVoiceMessageViewHolder<MESSAGE extends IMessage> 
    ...
    protected String getVoiceUrl(MESSAGE message) {
        try {
            ...
            Log.d("IncomingVoiceViewHolder", "Could not extract voice URL: " + e.getMessage());
        }
        return null;
    }
    ...
    protected int getVoiceDuration(MESSAGE message) {
        try {
            ...
            Log.d("IncomingVoiceViewHolder", "Could not extract voice duration: " + e.getMessage());
        }
        return 0;
    }
}